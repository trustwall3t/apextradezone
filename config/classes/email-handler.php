...
class email_handler {
	...
	*/
	...
	protected function designInterface( $message, $username ) { 
		...
		if( empty($this->title) ) $this->title = "Thank you for investing on " . $settings['name'];
	...
	<div style="background:#fff;max-width: 600px; margin: 0px auto; padding: 30px;"class="be_inner_containr"> 
		...
		<div class="be_body" style="padding: 20px 0;"> 
			...
			<div class="be_footer">
				...
				<div class="be_bluebar" style="background: green; padding: 20px; color: #fff;margin-top: 10px; text-align: center;">
